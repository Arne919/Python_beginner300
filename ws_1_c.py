...
# first_char 변수에 할당 할 글자는 password 문자열의 28번째부터 35번째까지에 작성된 글자이다.
# second_word 변수에 할당 할 단어는 password 문자열의 113번째부터 총 5글자이다.
# third_word 변수에 할당 할 단어는 password 문자열의 66번째부터 68번째까지 작성된 글자를 뒤집어서 출력한다.
# fourth_word 변수에 할당 할 단어는 password 문자열의 322번째부터 총 4글자를 뒤집어서 출력한다.
# fifth_word 변수에 할당 할 단어는 password 문자열의 365번째부터 작성된 'python'이다.
# 각 변수에 할당한 문자열의 f-string을 활용하여 출력하시오.
